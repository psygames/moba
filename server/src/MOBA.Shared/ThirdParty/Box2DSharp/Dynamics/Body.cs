...
namespace Box2DSharp.Dynamics
{
    ...
    public class Body : IDisposable
    {
        ...
        /// <summary>
        /// MOBA addition: Teleport without walking the broadphase. The next
        /// World.Step will Synchronize fixtures naturally as the body integrates,
        /// so we avoid per-respawn allocations from the broadphase MoveProxy path.
        /// </summary>
        public void SetTransformFast(in FVector2 position)
        {
            Transform.Position = position;
            Sweep.C  = MathUtils.Mul(Transform, Sweep.LocalCenter);
            Sweep.C0 = Sweep.C;
