    ...
    public class World : IDisposable
    {
        ...
        private void Solve(in TimeStep step)
        {
            ...
            while (bodyNode != null)
            {
                ...
                bodyNode = bodyNode.Next;
                if (body.Flags.HasSetFlag(BodyFlags.Island)) // 已经分配到岛屿则跳过
                {
                    continue;
                }
                ...
                while (stack.Count > 0)
                {
                    ...
                    while (node != null)
                    {
                        ...
                        // 接触点已经标记岛屿,跳过
                        if (contact.Flags.HasSetFlag(Contact.ContactFlag.IslandFlag))
                        {
                            continue;
                        }
...

            {
                ...
                while (bodyNode != null)
                {
                    ...
                    if (!b.Flags.HasSetFlag(BodyFlags.Island))
                    {
                        continue;
                    }
        ...
        private void SolveTOI(in TimeStep step)
        {
            ...
            for (;;)
            {
                ...
                while (contactNode != null)
                {
                    ...
                    var alpha = FP.One;
                    if (c.Flags.HasSetFlag(Contact.ContactFlag.ToiFlag))
                    {
