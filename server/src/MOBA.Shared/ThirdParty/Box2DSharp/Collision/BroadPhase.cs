...
namespace Box2DSharp.Collision
{
    public class BroadPhase : ITreeQueryCallback
    {
        ...
        public BroadPhase()
        {
            ...
            _pairCapacity = 2048;   // MOBA: pre-grown to avoid steady-state Array.Resize allocs
            _pairCount = 0;
            _pairBuffer = new Pair[_pairCapacity];
            _moveCapacity = 2048;   // MOBA: pre-grown to avoid steady-state Array.Resize allocs
            _moveCount = 0;
